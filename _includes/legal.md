...
**$POOL Token Community Launch Event.** <br>
The $POOL Token community launch Event (the “CLE”) is a bootstrapping event that will provide the platform and protocol with the necessary means to operate by the fees generated. The CLE is not a token sale nor a token offering, and Pool Party does not receive any proceeds from the CLE. Assets contributed to the CLE cannot be redeemed or withdrawn by Pool Party. Upon completion of the CLE, the assets are technically routed to the Pool Party treasury
